...
window.SITE_INDEX = [
  ...
  { title: "Builders — build intelligent agents", type: "Page", url: "builders.html",
    text: "Builders and developers create intelligent agents with identity, authority, and accountability. Every agent operates under a registered Duna: verifiable identity, scoped on-chain permissions, and an auditable ledger of its actions. Build agents people can trust." },
  { title: "Catalysts — ignite missions at scale", type: "Page", url: "catalysts.html",
    text: "Catalysts hold $100,000 in WVDuna and put it to work across the ecosystem: launching missions, challenges, grants, and initiatives, allocating capital, discovering opportunity, and connecting founders, builders, and sponsors into ventures bigger than any one Duna." },
  { title: "Luminaries — visionaries of the ecosystem", type: "Page", url: "luminaries.html",
    text: "Luminaries hold $1,000,000 in WVDuna and operate at planetary scale: launching ecosystem funds and institutes, coordinating global alliances across founders, builders, sponsors, and catalysts, and shaping the directions that define what everyone builds next." },
  { title: "Founders", type: "Page", url: "founders.html",
    text: "Meet the founders building member-owned, agent-powered organizations: Maya Calder, Cole Branham, Tomás Reyes, Renata Voss, Priya Nair, Jules Hartwell. The Dunas they founded and the allies who back them." },
